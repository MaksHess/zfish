...
LabelObjectID = NewType("LabelObjectID", tuple[LabelImageID, str])
...
class Resources:
    ...
    def validate_available(self, other: "Resources") -> Self:
        _validate_resources(self, other)
        return self


def _validate_resources(resources: Resources, available_resources: Resources):
